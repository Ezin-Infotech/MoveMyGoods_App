            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextWidgets(
                    text:
                        obj.bookingDetail.data!.goodsTypeName!.name.toString(),
                  ),
                  const SizeBoxH(10),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              : InkWell(
                                  onTap: () {
                                    context
                                        ...
                                        .changeShowPriceDetails(isShow: true);
                                  },
                                  child: Text(
                                    'View Price Details',
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizeBoxH(Responsive.height * 1),
                                TextWidgets(
                                  text: '₹ ${obj.bookingDetail.data!.baseFare}',
                                ),
                                SizeBoxH(Responsive.height * 1),
                                TextWidgets(
                                  text: '₹ ${obj.bookingDetail.data!.perKm}',
                                ),
                                SizeBoxH(Responsive.height * 1),
                                TextWidgets(
                                  text:
